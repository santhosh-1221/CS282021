...
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{figs/tflipflop.jpg}
	\caption{}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{figs/2ndstage.jpg}
	\caption{}
	\label{figs:2ndstage.}
\end{figure}
\begin{figure}[h]
       \centering
       \includegraphics[width=\columnwidth]{figs/3rdstage.jpg}
       \caption{}
       \label{figs:3rdstage.}
\end{figure}
\pagebreak
\begin{figure}[h]
         \centering
         \includegraphics[width=\columnwidth]{figs/4thstage.jpg}
         \caption{}
         \label{figs:4thstage.}
\end{figure}
\section{Hardware}
